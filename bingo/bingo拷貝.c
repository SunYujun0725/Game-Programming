...
int main() {
    ...
    while (1) {
        ...
        while (1) {
            ...
            char fri[7] = "friend";
            char my[7] = "myself";
            printf("Do you play with your friend or play by yourself?[friend/myself]");
            scanf("%s", play_with);
        ...
        if (partner == 0)  //自己玩
        {
            ...
            while (1) {
                char input_way[10];
                char manual[9] = "manually";
                char random[9] = "randomly";
                printf("Do you want to enter manually or randomly?:");
                scanf("%s", input_way);
            ...
            while (1) {
                ...
                char fri[7] = "friend";
                char I[7] = "I";
                printf("You first or your friend first?[I/friend]");
                scanf("%s", who_first);
